...
2) Папка db в backend хранит sql дамп, чтобы создать все нужные таблицы и монетки. 
Не настраивал dotnet tools для автомиграции, тк не пайплайн, но всегда можно через вход в контейнер запустить.
